            ...
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="offset-1 col-lg-3">
							<div class="card">
								<div class="card-body">
									<a href="<?php echo site_url('object/addObject?idUser='.$echange['idUser1'].'&idEchange='.$echange['idEchange'])?>">
					...
					<div class="offset-4 col-lg-3">
                        <div class="card">
                            <div class="card-body">
								<a href="<?php echo site_url('object/addObject?idUser='.$echange['idUser2'].'&idEchange='.$echange['idEchange'])?>">
									<button type="button" class="btn btn-info">
										Add object 
										<span class="btn-icon-start text-info">
											<i class="fa fa-plus"></i>
