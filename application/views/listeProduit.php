    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <!--**********************************
            Content body start
        ***********************************-->
        <div class="content-body" style ="height:23%">
            <div class="container-fluid">
                ...
                <div class="table-responsive">
                    <table id="example3" class="display" style="min-width: 100%">
                        <thead>
                            <!-- idObject | titre | description  | prix    | idUser | nom   | prenom | image | nomCategorie -->
                            <tr>
                                <th>Sarkely</th>
                                <th>Titre</th>
                                <th>Description</th>
                        ...
                        <tbody>
                            <?php foreach($table as $donnes){?>
                            <tr>
                                <td><img class="rounded-circle" width="35" src="images/profile/small/pic1.jpg" alt=""></td>
                                <td><?php echo $donnes['titre']?></td>
                                <td><?php echo $donnes['description']?></td>
                                <td><?php echo $donnes['prix']?></td>
                                <td><?php echo $donnes['nom']?></td>
                                <td><a href="javascript:void(0);"><strong><?php echo $donnes['nomCategorie']?></strong></a></td>
                                <td>
                                    <div class="d-flex">
                                        <a href="<?php echo base_url('Categorie/sendUpdate')?>?id=<?php echo $donnes['idObject']?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
