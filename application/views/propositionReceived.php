        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                    	<div class="card students-list">
							<div class="card-header border-0 flex-wrap pb-0">
								<h4><?php echo $echange['nom1']." ".$echange['prenom1']; ?></h4>
							</div>
								...
								<div class="table-responsive">
									<table class="table display mb-4 dataTablesCard order-table card-table text-black application" id="application-tbl1">
										<thead>
											<tr>
												<th>Titre</th>
												<th>Prix estimatifs</th>
												<th>Catégorie</th>
												<th></th>
											</tr>
										</thead>
										<tbody>
											<?php foreach ($objectSends as $objectSend) { ?>
											<tr>
												<td>
													<div class="d-flex align-items-center">
 														<img src="images/courses/pic3.jpg" alt="">
														<h4 class="mb-0 fs-16 font-w500"><?php echo $objectSend['titre']; ?></h4>
													</div>
												</td>
												<td><?php echo $objectSend['prix']; ?></td>
												<td><?php echo $objectSend['nomCategorie']; ?></td>
												<td>
													<div class="dropdown">
                    ...
                    <div class="col-lg-6">
                        <div class="card students-list">
							<div class="card-header border-0 flex-wrap pb-0">
								<h4><?php echo $echange['nom2']." ".$echange['prenom2']; ?></h4>
							</div>
							<div class="card-body py-0">
								<div class="table-responsive">
									<table class="table display mb-4 dataTablesCard order-table card-table text-black application" id="application-tbl1">
										...
										<tbody>
											<?php foreach ($objectReceiveds as $objectReceived) { ?>
											<tr>
												<td>
													<div class="d-flex align-items-center">
 														<img src="images/courses/pic3.jpg" alt="">
														<h4 class="mb-0 fs-16 font-w500"><?php echo $objectReceived['titre']; ?></h4>
													</div>
												</td>
												<td><?php echo $objectReceived['prix']; ?></td>
												<td><?php echo $objectReceived['nomCategorie']; ?></td>
												<td>
													<div class="dropdown">
														<a href="javascript:void(0);" class="btn-link btn sharp tp-btn-light btn-dark" data-bs-toggle="dropdown" aria-expanded="false">
															<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<div class="dropdown-menu dropdown-menu-start">
															<a class="dropdown-item" href="<?php echo site_url('echange/validateEchange?idEchange='.$idEchange) ?>">Delete</a>
															<a class="dropdown-item" href="javascript:void(0);">Edit</a>
														</div>
													</div>
												</td>
            ...
            <div class="container-fluid">
                ...
                <div class="offset-8 col-lg-4">
                        <div class="card">
                            <div class="card-body">
								<a href="<?php echo site_url('echange/refuseEchange?idEchange='.$idEchange) ?>">
								...
								<a href="<?php echo site_url('echange/ValidateEchange?idEchange='.$idEchange) ?>">
