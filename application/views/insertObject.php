                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="needs-validation" novalidate action="<?php echo site_url('object/insertObject'); ?>" method="post">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="validationCustom01">Titre
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-12">
														<input type="text" class="form-control" id="validationCustom01"  placeholder="Veuillez entrer un titre.." required name="titre">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="validationCustom02">Prix estimatif <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-12">
                                                        <input type="number" class="form-control" id="validationCustom02"  placeholder="Veuillez entrer un prix estimatif" required name="prix">
														<div class="invalid-feedback">
												...
												<div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label" for="validationCustom05">Categorie
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-12">
                                                        <select class="default-select wide form-control" id="validationCustom05" name="idCategorie">
															<option  data-display="Select">Choisissez une categorie</option>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <textarea class="form-control" id="validationCustom04"  rows="5" placeholder="Une petite ou longue description" required name="description"></textarea>
														<div class="invalid-feedback">
