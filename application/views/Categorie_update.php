                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Changer la  Categorie de : <?php echo $valiny['titre']?>  </h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form class="form-valide-with-icon needs-validation" action="<?php echo base_url('Categorie/updateCategorie')?>" method="post">
                                        <div class="mb-3">
                                            <label class="text-label form-label" for="validationCustomUsername">Nom du Categorie</label>
                                            <div class="input-group">
                                                <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                                                <select name="idCateg" style="width: 66%; height:50px; border-radius:5px; border-color:gray;">
                                        ...
                                        <button type="submit" class="btn me-2 btn-primary">Confirmer</button>
                                    </form>
                                </div>
                            </div>
                        </div>
