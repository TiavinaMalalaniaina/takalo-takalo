...
<!-- Mirrored from getskills.dexignzone.com/xhtml/app-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Oct 2022 13:49:05 GMT -->
<head>
        <meta charset="utf-8">
	...
	<link href="<?php echo site_url('assets/vendor/lightgallery/css/lightgallery.min.css') ?>" rel="stylesheet">
...
<body>
            ...
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-4">
                                <h4 class="card-title">Modifier l'un des Categorie</h4>
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate at animi deleniti nemo odit cum modi aspernatur neque, omnis reiciendis! Sapiente ab quis nemo ad ullam quidem? Quo, asperiores sapiente!</p>
                            </div>
                            <a href="<?php echo site_url('object/giveObject'); ?>" class="btn btn-primary btn-sm">Liste Produit par Utilisateur</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Insertion Nouvel Categorie</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form class="form-valide-with-icon needs-validation" action="<?php echo base_url('Categorie/insertCategorie')?>" method="post">
                                        <div class="mb-3">
                                            <label class="text-label form-label" for="validationCustomUsername">Nom du Categorie</label>
                                            <div class="input-group">
                                                <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                                                <input type="text" class="form-control" name="name" id="validationCustomUsername" placeholder="Enter a nom du categorie.." required>
                                            </div>
                                        </div>
    ...
    ***********************************-->
	...
	<script src="<?php echo site_url('assets/vendor/lightgallery/js/lightgallery-all.min.js') ?>"></script>
...
<!-- Mirrored from getskills.dexignzone.com/xhtml/app-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Oct 2022 13:49:11 GMT -->
</html>