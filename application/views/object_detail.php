...
<!-- Mirrored from getskills.dexignzone.com/xhtml/ecom-product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Oct 2022 13:49:50 GMT -->
<head>
        <meta charset="utf-8">
...
<body>
        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade show active" id="first">
                                                <img class="img-fluid" src="<?php echo site_url('assets/images/product/1.jpg') ?>" alt="">
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="second">
                                                <img class="img-fluid" src="<?php echo site_url('assets/images/product/2.jpg') ?>" alt="">
                                            </div>
                                            ...
                                            <ul class="nav slide-item-list mt-3" role="tablist">
                                                <li role="presentation" class="show">
                                                    <a href="#first" role="tab" data-bs-toggle="tab">
                                                        <img class="img-fluid" src="<?php echo site_url('assets/images/tab/2.jpg'); ?>" alt="" width="50">
                                                    </a>
                                                </li>
                                        ...
                                        <div class="product-detail-content">
                                            ...
                                            <div class="new-arrival-content pr">
												...
												<div class="d-table mb-2">
													<p class="price float-start d-block"><?php echo $object['prix']; ?> Ar</p>
                                                </div>
                                                
                                                <p class="text-content"><?php echo $object['description'] ?></p>
												
												
													<div class="shopping-cart  mb-2 me-3">
														<a class="btn btn-primary" href="<?php echo site_url('echange/model'); ?>">
					...
					<div class="offset-1 col-xl-11 col-sm-6">
						<div class="card">
							<div class="card-header pb-0 border-0">
								<h4>Historique appartenance</h4>
							</div>
							<div class="card-body pt-0">
								...
								<div class="upcomming-task-widget d-flex justify-content-between">
									<div class="d-flex">
										...
										<div>
											<span><?php echo $his['nom'].' '.$his['prenom'] ?> </span>
											<h5></h5>
										</div>
									</div>
									<div class="">
										<span class="fs-12"><?php echo $his['dateEchange']; ?></span>
									</div>
								</div>
							<?php } ?>
    ...
    ***********************************-->
	...
	<!-- Rating -->
	<script src="<?php echo site_url('assets/vendor/star-rating/jquery.star-rating-svg.js'); ?>"></script>
...
<!-- Mirrored from getskills.dexignzone.com/xhtml/ecom-product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Oct 2022 13:49:52 GMT -->
</html>