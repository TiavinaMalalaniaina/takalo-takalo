                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="needs-validation" novalidate action="<?php echo site_url('object/do_upload'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                        ...
                                                        <div class="basic-form custom_file_input">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    <div class="col-lg-8 ms-auto">
                                                                        <button type="submit" class="btn btn-primary" name="filename">Ajouter</button>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <div class="col-lg-8 ms-auto">
                                                                        <a href="">
                                                                            <button type="button" class="btn btn-primary" name="filename">Terminer</button>
