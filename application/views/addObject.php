    ...
    ***********************************-->
    <div id="main-wrapper">
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
									<div class="profile-photo">
										<img src="<?php echo site_url('assets/images/profile/profile.png'); ?>" class="img-fluid rounded-circle" alt="">
									</div>
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											<h4 class="text-primary mb-0"><?php echo $user['nom']; ?> <?php echo $user['prenom']; ?></h4>
										</div>
								...
								<div class="courses-bx">
									...
									<div class="dlab-info">
										<div class="dlab-title d-flex justify-content-between">
											<div>
												<h4><a href="<?php echo site_url('object/detailObject?idObject='.$object['idObject']); ?>"><?php echo $object['titre']; ?></a></h4>
												<p class="m-0"><?php echo $object['nom'].' '.$object['prenom']; ?>
											...
											<h4 class="text-primary"><?php echo $object['prix']; ?><span>Ar</span></h4>
										</div>
										<div class="d-flex justify-content-between content align-items-center">
											...
											<a href="<?php echo site_url('proposition/addProposition?idObject='.$object['idObject']); ?>&idEchange=<?php echo $idEchange ?>" class="btn btn-primary btn-sm">Ajouter à l'échange</a>
										</div>
									</div>
								</div>
							</div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed   by <?php var_dump($user) ?> <a href="https://themeforest.net/user/hugebinary" target="_blank">HugeBinary</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
