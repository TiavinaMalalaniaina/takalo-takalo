							...
							<div class="form-container">
								<form method="post">
									<div class="form-group">
										<input type="nom" name="nom" class="form-control" placeholder="Name" required>
									</div>
									<div class="form-group">
									...
									<button class="btn mt-3">SINGUP</button>				
								</form>
							</div>
						</div>
						<div class="footer">
						<h4>Already have an account?
							<strong class="f"><a href="<?php site_url('welcome/login');?>">Log in</a></strong>
						</h4>
				</div>
			</div>
		</div>
